...
####################################################################
##  Edited to account for Rotten Tomatoes site redesign           ##
##  03/17/2023                                                    ##
####################################################################
...
next_buttons = driver.find_element(By.XPATH, "//rt-button[@class='js-prev-next-paging-next']")
...
while tester in test_str:
    ...
    raw_user = html.find_all("div", {"class": "audience-reviews__name-wrap"})
